...
const themes = [
    {
        name: 'Cyber Dark',
        bg: '#04040b', text: 'rgba(255,255,255,0.88)', heading: '#ffffff', muted: '#8b95a9',
        accent: '#22d3ee', accentRgb: '34,211,238', accentSecondary: '#06b6d4',
        glassBg: 'rgba(255,255,255,0.04)', glassBorder: 'rgba(255,255,255,0.08)',
        cardBorder: 'rgba(255,255,255,0.07)', cardHoverBorder: 'rgba(34,211,238,0.35)',
    },
    {
        name: 'Clean Neutral',
        bg: '#F6F5F2', text: '#1a1a1a', heading: '#000000', muted: '#4b5563',
        accent: '#00796B', accentRgb: '0,121,107', accentSecondary: '#005F52',
        glassBg: 'rgba(255,255,255,0.8)', glassBorder: 'rgba(0,0,0,0.1)',
        cardBorder: 'rgba(0,0,0,0.08)', cardHoverBorder: 'rgba(0,121,107,0.35)',
    },
    {
        name: 'Deep Navy',
        bg: '#0C1B2A', text: '#E5E7EB', heading: '#ffffff', muted: '#94A3B8',
        accent: '#00C2FF', accentRgb: '0,194,255', accentSecondary: '#0099CC',
        glassBg: 'rgba(0,194,255,0.04)', glassBorder: 'rgba(0,194,255,0.12)',
        cardBorder: 'rgba(255,255,255,0.06)', cardHoverBorder: 'rgba(0,194,255,0.35)',
    },
    {
        name: 'Warm Coffee',
        bg: '#2E1F1A', text: '#F1E3D3', heading: '#ffffff', muted: '#C4B5A0',
        accent: '#FF9F43', accentRgb: '255,159,67', accentSecondary: '#E68A2E',
        glassBg: 'rgba(255,159,67,0.06)', glassBorder: 'rgba(255,159,67,0.15)',
        cardBorder: 'rgba(255,255,255,0.07)', cardHoverBorder: 'rgba(255,159,67,0.35)',
    },
    {
        name: 'Void Green',
        bg: '#040f08', text: 'rgba(220,255,220,0.88)', heading: '#e8ffe8', muted: '#5a8a6a',
        accent: '#00FF88', accentRgb: '0,255,136', accentSecondary: '#00cc6a',
        glassBg: 'rgba(0,255,136,0.04)', glassBorder: 'rgba(0,255,136,0.10)',
        cardBorder: 'rgba(0,255,136,0.08)', cardHoverBorder: 'rgba(0,255,136,0.35)',
    },
];

const messages = ['TRY ME', 'TRY AGAIN?', 'ANOTHER ONE?', 'HOW ABOUT THIS?', 'BACK TO DEFAULT'];
